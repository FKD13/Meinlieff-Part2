...
import mijnlieff.Part1.Updated.PartOneCompanion;
...
public class Mijnlieff extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        if (getParameters().getRaw().size() == 0) {
            ...
            openWindow("/mijnlieff/ServerSelection/ServerSelection.fxml", new ServerSelectionCompanion(this, client));
            // FXMLLoader loader = new FXMLLoader(getClass().getResource("/mijnlieff/ServerSelection/ServerSelection.fxml"));
            ...
            if (!getParameters().getRaw().get(1).matches("[0-9]+")) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/mijnlieff/Part1/PartOne.fxml"));
