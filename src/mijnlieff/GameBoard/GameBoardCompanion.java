...
public class GameBoardCompanion implements Companion {
    ...
    public GameBoardCompanion(Mijnlieff mijnlieff, Client client, ArrayList<Point> boardconfiguration, boolean color, String board) {
    ...
    private void quit(String reason) {
        mijnlieff.openWindow("/mijnlieff/GameFinished/GameFinished.fxml", new GameFinishedCompanion(mijnlieff, client, reason));
    }
